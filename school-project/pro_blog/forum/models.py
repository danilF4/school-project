...
class Post(models.Model):
	...
	def like_a_post(self):
	    return "/forum/like/{}/".format(self.pk)

	def get_update_post(self):
	    return "/forum/question/detail/{}/update".format(self.pk)

	def get_delete_post(self):
	    return "/forum/question/detail/{}/delete".format(self.pk)
...
class Comment(models.Model):
	...
	def comment_add_like(self):
		return "/forum/comment/{}/like".format(self.id)

	def vote_comment_up(self):
		return "/forum/comment/{}/vote-up/".format(self.id)

	def vote_comment_down(self):
		return "/forum/comment/{}/vote-down/".format(self.id)